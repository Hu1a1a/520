(function (window) {
  ...
  Seed.prototype = {
    ...
    drawText: function () {
      ...
      ctx.moveTo(0, 0);
      ctx.scale(0.75, 0.75);
      ctx.font = "5px 微软雅黑,Verdana";
      ctx.fillText("点我，点我，快点我！！！", 21, 18);
      ctx.restore();
    },
    clear: function () {
      var ctx = this.tree.ctx,
  ...
  Tree.prototype = {
    //semilla bajada corazon
    initSeed: function () {
      var seed = this.opt.seed || {};
      var x = seed.x || this.width / 2;
      var y = seed.y || this.height / 2; //distancia del corazon
    ...
    initFooter: function () {
      ...
      var height = footer.height || 5; //grosor del suelo
    ...
    addBranchs: function (branchs) {
      ...
      for (var i = 0; i < branchs.length; i++) {
        b = branchs[i];
        p1 = new Point(b[0] + ajusteX, b[1] + ajusteY);
        p2 = new Point(b[2] + ajusteX, b[3] + ajusteY);
        p3 = new Point(b[4] + ajusteX, b[5] + ajusteY);
        r = b[6];
        l = b[7];
        c = b[8];
